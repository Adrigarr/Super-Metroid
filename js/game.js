...
window.addEventListener('load', function() {
     ...
     */
    Q.loadTMX('level.tmx, mainTitle.png, mario_small.png, mario_small.json, skree.png, skree.json, goomba.png, goomba.json, bloopa.png, bloopa.json, piranha.png, piranha.json, princess.png, coin.png, coin.json, music_main.mp3, music_main.ogg, music_die.mp3, music_die.ogg, music_level_complete.mp3, music_level_complete.ogg, coin.mp3, coin.ogg', function() {
